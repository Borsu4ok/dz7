...
namespace MediatorExample
{
    ...
    class ConcreteMediator : Mediator
    {
        ...
        public ConcreteColleague3 Colleague3 { set { colleague3 = value; } }

        public override void Send(string message, Colleague colleague)
        {
            // route message from one colleague to the others
    ...
    // "ConcreteColleague3" (new)
    class ConcreteColleague3 : Colleague
    {
        public ConcreteColleague3(Mediator mediator) : base(mediator) { }
        public void Send(string message) { mediator.Send(message, this); }
        public void Notify(string message) { Console.WriteLine("Colleague3 gets message: " + message); }
    }
